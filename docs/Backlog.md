...
|---|---|---|---|---|
| BL-001 | P1 | Add a normative glossary | Reduce ambiguity in recurring terms without scattering definitions | 0.3.0 |
| BL-002 | P1 | Define machine-readable collaboration-profile schema | Enable validation and tooling while preserving Markdown as human-readable source | 0.3.0 research |
| BL-003 | P1 | Create a conformance test catalogue | Turn behavioural requirements into repeatable observable tests | 0.3.0 |
| BL-004 | P1 | Add repository linting | Validate links, metadata, versions, duplicate headings, and normative keywords | 0.3.0 |
...
| BL-006 | P2 | Evaluate standard open-source licenses | Requires repository-owner intent regarding reuse and contribution | Before public release |
...
| BL-009 | P2 | Add worked project-profile examples | Demonstrate inheritance, extensions, and explicit overrides | 0.3.0 |
